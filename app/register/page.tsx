      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 w-full items-center">
        ...
        >
          ...
          <h1 className="text-5xl font-bold">
            {isSignIn
              ? "One Platform. All Your Finance Operations."
              : "SCALE YOUR FINANCES"}
          </h1>
        ...
        >
          <h2 className="text-[32px] font-semibold mb-6">
            {isSignIn ? "Welcome Back!" : "Ready to experience Zyvo in action?"}
          </h2>
          ...
          {isSignIn && (
            <form className="space-y-4 w-full">
              ...
              <div className="text-center">
                <button
                  type="button"
                  className="text-[#57F7FD] text-sm hover:underline"
                >
          ...
          <div className="text-center">
            <p className="text-white/70 text-sm">
              ...
              <button
                ...
                className="text-[#57F7FD] ml-2 hover:underline font-medium"
              >
